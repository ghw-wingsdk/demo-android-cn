 ...
 */
public class Rank360Activity extends BaseActivity implements ViewPager.OnPageChangeListener, AdapterView.OnItemClickListener {
    ...
    private void queryRankFriend() {
        WASocialProxy.queryRankFriend(this, WAConstants.CHANNEL_QIHU360, 0, true, new WACallback<WARankResult>() {
            ...
            public void onSuccess(int code, String message, WARankResult result) {
                ...
                listView.setAdapter(new ArrayAdapter<String>(Rank360Activity.this, android.R.layout.simple_list_item_1, datas));
            }
